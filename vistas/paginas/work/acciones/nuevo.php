            ...
            <div class="content col-lg-9">
                ...
                <form method="post" enctype='multipart/form-data'>
                    <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input class="form-control" type="text" placeholder="Escriba un título" name="titulo" id="titulo">
                            </div>
                    </div>
                    <div class="form-group row">
                            <label for="artista" class="col-3 col-form-label">Artista</label>
                            <div class="col-9">
                                <input class="form-control" type="text" placeholder="Escriba el artista" name="artista" id="artista">
                            </div>
                    </div>
                    <div class="form-group row">
                            <label for="artista" class="col-3 col-form-label">Información</label>
                            <div class="col-9">
                            <textarea id="summernote" name="informacion" >
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input class="form-control" type="text" placeholder="Escriba el link" name="link" id="link">
                            </div>
                    </div>
